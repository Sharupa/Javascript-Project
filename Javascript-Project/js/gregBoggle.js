function words(x)
{
	...
	case 5:
		...
		break;
	case 6:
		var word = new Array("oekbootn","Notebook","book","note","ton","took","boot","ten","knot","bent","knob","net","boot","bet","not","took","too");
		break;
	case 7:
		var word = new Array("ancparaeep","appearance","app","appear","ear","an","ran","reap","pear","can","pan","nap","cap","cape","ape","near","pen","care","peep","pace","rap","peace","ace","cane","crane");
		break;
	}
	return word;
}
